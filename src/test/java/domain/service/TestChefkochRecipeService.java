...
4. Dazu Reis oder Ciabatta reichen.
  ...
  * */
  ...
  void setUp() {
    ...
    GroceryItem i1 = new GroceryItem(new Ingredient("Schweinefilet(s)"), new Quantity(500), new Unit("g"));
    GroceryItem i2 = new GroceryItem(new Ingredient("Parmaschinken, in dünnen Scheiben"), new Quantity(150), new Unit("g"));
    GroceryItem i3 = new GroceryItem(new Ingredient("Zwiebel(n)"), new Quantity(1), new Unit("Stk."));
    GroceryItem i4 = new GroceryItem(new Ingredient("Knoblauch"), new Quantity(3), new Unit("Zehe/n"));
    GroceryItem i5 = new GroceryItem(new Ingredient("Oliven, schwarze"), new Quantity(50), new Unit("g"));
    GroceryItem i6 = new GroceryItem(new Ingredient("Tomaten, stückige"), new Quantity(1), new Unit("Dose"));
    ...
    RecipeStep step1 = new RecipeStep(1, "Schweinefilet in Medaillons schneiden, diese mit Parmaschinken umwickeln und in eine Auflaufform legen.");
    RecipeStep step2 = new RecipeStep(2, "Zwiebeln und Knoblauch würfeln und in Olivenöl anschwitzen, aber keine Farbe nehmen lassen. Dosentomaten und Oliven dazugeben und langsam erhitzen, mit den Kräutern und Gewürzen abschmecken. Die Sahne dazugeben und aufkochen lassen. Evtl. nachwürzen. Es darf gerne auch scharf sein.");
    RecipeStep step3 = new RecipeStep(3, "Die Soße auf die Schweinefiletscheiben geben und die Form für ungefähr 45 Minuten bei 180 Grad in den Ofen geben.");
